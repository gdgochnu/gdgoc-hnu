...
- [x] 10.3 Build low-engagement alerts + HR notes/follow-up log. (2026-09-08)
- [x] 10.4 Build the monthly `performance_reviews` computation job. (2026-09-08)
...
- [x] 17.2 Wire every trigger from spec §4.11's table (incl. delegation, broadcast assignment, check-in duty, onboarding checklist, feedback survey, budget alerts, alumni archived) to create a `notifications` row. (2026-09-09)
...
- [x] S.D.4 Wire attendance into student dashboard: Attendance Summary card (total sessions attended vs enrolled), attendance rate %, history list.
- [x] S.D.5 Confirm end-to-end: HR scans student QR at a course session → attendance recorded → student sees updated attendance on dashboard; instructor views session attendance sheet with timestamps.
