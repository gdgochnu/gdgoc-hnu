...
import { submitEventForReview } from '@/app/events/actions';
...
export function EventReviewBanner({ event, canManage, approvalInstance }: EventReviewBannerProps) {
  ...
  if (!isDraftOrRejected && !isInReview && !isApproved) {
    return null;
  }
      ...
      <div
        ...
        style={{
          ...
          background: isDraftOrRejected
            ...
            : 'linear-gradient(135deg, rgba(52, 168, 83, 0.08), rgba(0, 0, 0, 0.4))',
          display: 'flex',
          alignItems: 'center',
          ...
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.6rem' }}>
              <h4 style={{ fontSize: '1.05rem', fontWeight: 800, margin: 0 }}>
                {isDraftOrRejected
                  ...
                  : 'Event Approved & Ready to Publish'}
              </h4>
            ...
            <p style={{ color: 'var(--text-secondary)', fontSize: '0.82rem', margin: '0.2rem 0 0' }}>
              {isDraftOrRejected ? (
                ...
                'This event has received all required executive approvals. You can now publish it to the public student portal.'
              )}
            </p>
          </div>
        </div>
